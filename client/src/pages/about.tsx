        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <motion.div
              ...
              className="aspect-[3/4] bg-white rounded-lg overflow-hidden relative shadow-xl"
            >
              <img
                src="/attached_assets/leandro-araujo.jpeg.jpeg"
                alt="Leandro Araújo — Fundador da Lupa Pesquisas"
                className="w-full h-full object-cover object-center"
                onError={(e) => {
                  const t = e.target as HTMLImageElement;
                  t.onerror = null;
                  t.src = "https://placehold.co/400x600?text=Leandro+Araujo";
                }}
              />
